    ...
    <div class="wrapper bg-white" style="margin-top:100px">
        ...
        <div class="d-flex align-items-start justify-content-between mt-5">
            <div class="d-flex flex-column">
                ...
                <br>
                <span>
                    <a href="{{ url('todo/create') }}" class="text-success">Create</a>  <a href="{{ route('completed') }}">Complated</a>
                </span>
            </div>
         ...
         @foreach ($data as $item )
            <div class="comment d-flex align-items-start justify-content-between border-bottom" style="border-radius: none;">
                <div class="mr-2">
                    ...
                    @if($item['status'] == 1)
                    <span class="fa-solid fa-bookmark text-secondery btn"></span>
                    @else
                ...
                <div class="d-flex flex-column">
                    ...
                    <p class="text-muted"> {{$item['status'] == 1 ? 'Complated ' : 'On-Proccess '}}
                        @if($item['status'] == 1)
                        <span class="date">Selesai pada: {{\Carbon\Carbon::parse($item['done_item'])->format('j, F Y' )}}</span>
                        @else
